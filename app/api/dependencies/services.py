...
def get_authentication_service(
    ...
    return AuthenticationService(user_repository, jwt_service)
...
def get_project_service(projects_repository: ProjectsRepositoryDep) -> ProjectService:
...
def get_task_service(
    projects_service: ProjectServiceDep, task_repository: TaskRepositoryDep
) -> TaskService:
