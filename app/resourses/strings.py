...
PROJECT_DOES_NOT_EXIST_ERROR = "article does not exist"
PROJECT_ALREADY_EXISTS = "project with this title already exists"
USER_IS_NOT_OWNER_OF_PROJECT = "user is not an owner of this project"
